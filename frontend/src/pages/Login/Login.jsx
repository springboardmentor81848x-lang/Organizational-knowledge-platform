...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("userName", "Prashanthi");
          ...
          <div className="google-modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            {googleStep === 1 && (
              <div className="google-account-list">
                ...
                >
                  <img src="https://i.pravatar.cc/100?img=32" alt="Prashanthi Bingi" className="account-avatar" />
                  <div className="account-details">
                    <strong className="account-name">Prashanthi Bingi</strong>
                    <span className="account-email">prashanthi123@gmail.com</span>
                  </div>
                </div>
                ...
                <div
                  ...
                  onClick={() => handleSelectExistingAccount({
                    firstName: "Prashanthi",
                    lastName: "Bingi",
                    email: "work.prashanthi@gmail.com",
                    avatar: "https://i.pravatar.cc/100?img=47"
                  })}
                >
                  <img src="https://i.pravatar.cc/100?img=47" alt="Work Prashanthi" className="account-avatar" />
                  <div className="account-details">
                    <strong className="account-name">Work Prashanthi</strong>
                    <span className="account-email">work.prashanthi@gmail.com</span>
                  </div>
                </div>
