...
export default function ExpertDirectory() {
  ...
  const fetchExperts = async () => {
    try {
      ...
      if (minProficiency > 0) {
        params.append('minProficiency', String(minProficiency));
      }

      if (employeeId) {
        params.append('currentEmployeeId', employeeId);
      }

      const response = await api.get(
        `/expert-directory/search?${params.toString()}`,
        getHeaders()
      );
  ...
  const fetchMetadata = async () => {
    try {
      const [deptRes, skillRes] = await Promise.all([
        api
          .get('/expert-directory/departments', getHeaders())
          .catch(() => ({ data: [] })),

        api
          .get('/expert-directory/skills', getHeaders())
          .catch(() => ({ data: [] })),
      ]);
  ...
  const handleSendMentorshipRequest = async () => {
    ...
    if (!mentorshipGoal.trim()) {
      setError(
        'Please provide a goal/reason for your mentorship request.'
      );
      return;
    }
    ...
    if (
      ...
      String(selectedExpert.employeeDbId) ===
        String(localStorage.getItem('userId'))
    ) {
      setError(
        'You cannot request peer mentorship from yourself.'
      );
      return;
    }
    ...
    try {
      ...
      params.append(
        'mentorIdentifier',
        selectedExpert.employeeId
      );
      params.append(
        'skillId',
        String(selectedExpert.skillId)
      );
      ...
      console.error(
        'Error sending mentorship request:',
        err
      );
  ...
  const stats = useMemo(() => {
    const totalExperts = new Set(
      experts.map((e) => e.employeeId)
    ).size;

    const totalSkills = new Set(
      experts.map((e) => e.skillName)
    ).size;

    const topDepartments = new Set(
      experts.map((e) => e.department)
    ).size;
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              ...
              <div className="space-y-2 max-w-2xl">
                ...
                <p className="text-blue-100 text-sm md:text-base leading-relaxed">
                  Search for internal experts across skills,
                  proficiency levels, and departments. Connect
                  for peer-to-peer (Employee-to-Employee)
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-white/10 p-3 rounded-xl backdrop-blur-sm border border-white/15">
                ...
                <div className="text-center px-3 py-2">
                  ...
                  <div className="text-[11px] text-blue-200 font-medium uppercase tracking-wider">
                    Experts
                  </div>
                </div>
                ...
                {loading ? (
                  ...
                  <div className="bg-white rounded-2xl border border-dashed border-slate-300 p-12 text-center shadow-sm">
                    ...
                    <h3 className="text-base font-semibold text-slate-700">
                      No internal experts found
                    </h3>

                    <p className="text-sm text-slate-500 mt-1 max-w-md mx-auto">
                      Try searching with different keywords
                      (e.g. "Java", "React", "SQL") or resetting
                      your department and proficiency filters.
                    </p>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                  ...
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-600 text-white font-bold flex items-center justify-center shadow-sm text-sm shrink-0">
                                      {expert.firstName?.charAt(
                                        0
                                      ) || ''}

                                      {expert.lastName?.charAt(
                                        0
                                      ) || ''}
                                    </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-start justify-between gap-3">
                            ...
                            <span
                              className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold border ${badgeStyle}`}
                            >
                              <Award size={12} />
                              {expert.proficiency}
                            </span>
                          ...
                          <div className="pt-1">
                            ...
                            {isSelf ? (
                              <button
                                disabled
                                className="w-full py-2 bg-slate-100 text-slate-400 text-xs font-semibold rounded-xl"
                              >
                                Your Profile
                              </button>
                            ) : (
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div>
                  ...
                  <h2 className="text-lg font-bold text-slate-800">
                    My Peer Mentorship Relationships
                  </h2>

                  <p className="text-sm text-slate-500">
                    Overview of your sent and active peer
                    mentorships initiated through the Expert
                    Directory.
                  </p>
              ...
              {mentorshipLoading ? (
                ...
                <div className="bg-white rounded-2xl border border-dashed border-slate-300 p-12 text-center shadow-sm">
                  ...
                  <p className="text-sm text-slate-500 mt-1 max-w-md mx-auto">
                    Use the Expert Directory to search for
                    colleagues skilled in topics you want to
                    learn, and click "Request Mentorship" to
                    start!
                  </p>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="w-10 h-10 rounded-xl bg-blue-100 text-blue-700 font-bold flex items-center justify-center text-sm">
                            {m.mentor?.firstName?.charAt(
                              0
                            ) || 'M'}

                            {m.mentor?.lastName?.charAt(
                              0
                            ) || ''}
                          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-lg w-full p-6 space-y-5">
            ...
            <div className="flex items-start justify-between border-b border-slate-100 pb-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  Connect with internal expert for knowledge
            ...
            <div className="flex items-center gap-3 bg-blue-50/70 border border-blue-100 rounded-xl p-4">
              ...
              <div className="w-12 h-12 rounded-xl bg-blue-600 text-white font-bold flex items-center justify-center text-base shadow-sm shrink-0">
                ...
                {selectedExpert.firstName?.charAt(
                  0
                ) || ''}

                {selectedExpert.lastName?.charAt(
                  0
                ) || ''}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`text-[11px] font-semibold px-2 py-0.5 rounded-full border ${
                      levelBadgeStyles[
                        selectedExpert.proficiencyLevel
                      ] || ''
                    }`}
                  >
            ...
            <div className="space-y-1.5">
              ...
              <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider">
                Mentorship Goal / Request Message{' '}
              ...
              <textarea
                ...
                onChange={(e) =>
                  setMentorshipGoal(e.target.value)
                }
              ...
              <p className="text-[11px] text-slate-400">
                A clear goal helps the expert understand your
                needs and respond faster.
              </p>
