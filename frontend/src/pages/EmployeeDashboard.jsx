...
function EmployeeDashboard() {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      //
      // We are NOT calling detectGaps() here.
      //
      // We only retrieve the knowledge gaps already saved
      // for this employee.
      // =====================================================
  ...
  const getRequiredLevel = (
    ...
    /*
     * If backend stores requiredLevel,
     * use it directly.
     */
     ...
     * Fallback:
     *
     * If gap is stored as a level difference:
     *
     * Current = 3
     * Gap = 2
     *
  ...
  const getSkillGap = (
    ...
    /*
     * If requiredLevel exists,
     * always use calculated difference.
     */

    if (
      Number(matchingGap?.requiredLevel || 0) > 0
    ) {
              ...
              <div className="space-y-6">
                ...
                {skills.map(
                  (item, index) => {
                    ...
                    /*
                     * If there is no gap for
                     * this skill, required level
                     * is current level.
                     */
