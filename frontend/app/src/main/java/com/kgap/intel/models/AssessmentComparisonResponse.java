...
public class AssessmentComparisonResponse {
    ...
    public Double getPeerScore() { return peerScore; }
    public void setPeerScore(Double peerScore) { this.peerScore = peerScore; }
    ...
    public String getCombinedProficiencyLevel() { return combinedProficiencyLevel; }
    public void setCombinedProficiencyLevel(String combinedProficiencyLevel) { this.combinedProficiencyLevel = combinedProficiencyLevel; }
}
