...
public interface MentorApiService {
    ...
    @GET("mentors")
    Call<List<MentorProfileResponse>> getAllMentors(@Query("requesterId") Long requesterId);
    ...
    @GET("mentors/search")
    Call<List<MentorProfileResponse>> searchMentors(@Query("expertise") String expertise, @Query("requesterId") Long requesterId);
}
