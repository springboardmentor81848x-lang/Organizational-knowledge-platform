...
public class MentorProfileFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        reqRepo.getRequestsForMentee(currentUserId).observe(getViewLifecycleOwner(), requests -> {
            boolean isAccepted = false;
            boolean isPending = false;
            if (requests != null) {
                for (com.kgap.intel.models.MentorshipRequest req : requests) {
                    if (req.getMentorId() != null && req.getMentorId().equals(finalMentorId)) {
            ...
            if (isAccepted) {
                ...
                binding.btnMessage.setVisibility(View.GONE);
                binding.btnRequestMentorship.setVisibility(View.VISIBLE);
                binding.btnRequestMentorship.setText("⏳ Request Pending");
                binding.btnRequestMentorship.setEnabled(false);
            } else {
                binding.btnMessage.setVisibility(View.GONE);
                binding.btnRequestMentorship.setVisibility(View.VISIBLE);
                binding.btnRequestMentorship.setText("Request Mentorship");
                binding.btnRequestMentorship.setEnabled(true);
