    ...
    <div className="space-y-6">
      ...
      {showBuilder ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {paths.map(p => (
            <div key={p.id} className="bg-white dark:bg-[#0F1420] border border-slate-200/70 dark:border-white/5 rounded-2xl p-5 flex flex-col justify-between shadow-xs">
              ...
              <div className="flex items-center justify-between border-t border-slate-100 dark:border-white/5 pt-3 mt-4 text-xs">
                <span className="text-slate-500 dark:text-slate-400">{p.enrolledCount || 0} active enrollments</span>
                <button
