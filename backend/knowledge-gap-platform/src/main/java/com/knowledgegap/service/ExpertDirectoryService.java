...
public class ExpertDirectoryService {
    ...
    public List<ExpertDirectoryDTO> searchExperts(
        ...
        String normalizedCategory =
                (skillCategory != null) ? skillCategory.trim().toLowerCase() : "";

        int requiredMinProficiency =
                (minProficiency != null && minProficiency > 0)
                        ? minProficiency
                        : 1;
        ...
        return allEmployeeSkills.stream()
                ...
                // ---------------------------------------------
                // IMPORTANT:
                // ONLY EMPLOYEES SHOULD APPEAR IN EXPERT DIRECTORY
                //
                // Excludes:
                // MENTOR
                // MANAGER
                ...
                .filter(es -> {
                    ...
                    if (employee.getRole().getRoleName() == null) {
                        return false;
                    }
                ...
                .filter(es -> {
                    ...
                    if (skillId != null && skillId > 0) {
                        ...
                        return es.getSkill().getId() != null &&
                               es.getSkill().getId().equals(skillId);
                    }
                ...
                .filter(es -> {
                    ...
                    if (!normalizedDept.isEmpty()
                            && !"all".equalsIgnoreCase(normalizedDept)) {

                        String deptName =
                                resolveDepartmentName(es.getEmployee());

                        if (deptName == null ||
                            !deptName.toLowerCase()
                                    .contains(normalizedDept)) {
                ...
                .filter(es -> {
                    ...
                    String dept =
                            resolveDepartmentName(emp);

                    String skillName =
                            (skill.getSkillName() != null)
                                    ? skill.getSkillName().toLowerCase()
                                    : "";
                    ...
                    String designation =
                            (emp.getDesignation() != null)
                                    ? emp.getDesignation().toLowerCase()
                                    : "";
                    ...
                    String employeeCode =
                            (emp.getEmployeeId() != null)
                                    ? emp.getEmployeeId().toLowerCase()
                                    : "";

                    String departmentLower =
                            (dept != null)
                                    ? dept.toLowerCase()
                                    : "";
    ...
    // =========================================================
    // MAP EMPLOYEE SKILL TO DTO
    // =========================================================

    private ExpertDirectoryDTO mapToDTO(
            EmployeeSkill es) {
