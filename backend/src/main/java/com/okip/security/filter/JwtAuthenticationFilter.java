package com.okip.security.filter;
...
import com.okip.security.service.CustomUserDetailsService;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (username != null &&
            ...
            if (jwtService.isTokenValid(jwt, userDetails)) {
                ...
                // ✅ Create authentication with authorities (roles)
                UsernamePasswordAuthenticationToken authentication =
                        new UsernamePasswordAuthenticationToken(
                                userDetails,
                                null,
                                userDetails.getAuthorities());  // ✅ This sets the role
