...
* The original package name 'com.knowledge.knowledge-platform' is invalid and this project uses 'com.knowledge.knowledge_platform' instead.
...
* [Spring Data Redis (Access+Driver)](https://docs.spring.io/spring-boot/4.0.7/reference/data/nosql.html#data.nosql.redis)
* [Spring Data Elasticsearch](https://docs.spring.io/spring-boot/4.0.7/reference/data/nosql.html#data.nosql.elasticsearch)
