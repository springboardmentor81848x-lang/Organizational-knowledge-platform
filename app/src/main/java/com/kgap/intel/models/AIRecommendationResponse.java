...
public class AIRecommendationResponse implements Serializable {
    ...
    public AIRecommendationResponse(String skillName, String currentLevel, String requiredLevel, String gapLevel, int priority, String recommendation, String reason) {
